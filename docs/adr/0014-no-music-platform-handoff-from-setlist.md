...
歌单猜想 will not open a default music app search for a song, and the Settings entry **默认音乐平台** will be removed in this version. Users still get song title, artist, order, two-tier confidence, star/edit/share, and generation — not in-app试听 or platform deep links.
