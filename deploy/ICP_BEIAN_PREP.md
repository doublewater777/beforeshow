...
- APP 名称：开场前
- 英文名/别名：BeforeShow
- 服务内容：音乐现场开场前准备工具，提供现场倒计时、候选曲目、往返计划、现场准备和本地现场碎片记录。
...
- 若包含 AI 生成、音乐平台跳转等能力，备案描述里避免写成新闻、出版、网络游戏、网络视听节目、票务交易、社交社区等需要额外资质或改变业务性质的类别。
...
- 已完成：内容权利声明 `USES_THIRD_PARTY_CONTENT`，因为 V2.1 会引用第三方音乐标题和用户选择的图库媒体，但不托管或播放第三方视频。
