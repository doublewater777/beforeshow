...
final class ListeningReviewerRegressionTests: XCTestCase {
    ...
    func testListeningMachineUsesLargeLCDAndDedicatedFourControlDeck() throws {
        ...
        XCTAssertTrue(machine.contains("CDPlayerLCDStatusView"))
        XCTAssertTrue(machine.contains("CDPlayerLCDMeterView"))
        XCTAssertTrue(machine.contains("CDPlayerButtonFace"))
        XCTAssertTrue(machine.contains("CDPlayerControlIcon"))
        XCTAssertTrue(machine.contains("\"eject.fill\""))
        XCTAssertTrue(machine.contains("\"STANDBY\""))
        ...
        XCTAssertTrue(machine.contains("opaqueOuterFace"))
        XCTAssertTrue(machine.contains("transparentOuterFace"))
        XCTAssertTrue(machine.contains("innerFace"))
        XCTAssertFalse(machine.contains("configuration.assets.body"))
        XCTAssertFalse(machine.contains("configuration.assets.lidOuter"))
        XCTAssertFalse(machine.contains("configuration.assets.lidInner"))
