    ...
    private func clearLocalData() {
        ...
        Task { @MainActor in
            do {
                ...
                do {
                    try context.delete(model: ShowWantsLiveSong.self)
                    try context.delete(model: ShowArtistListeningPreference.self)
                    try context.delete(model: ShowOpeningFamiliarityBaseline.self)
                    try context.delete(model: ShowOpeningArtistTier.self)
                    ...
                    try context.delete(model: CatalogAlbum.self)
