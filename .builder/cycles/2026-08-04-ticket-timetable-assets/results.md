...
- Focused media run: 60 tests passed, 0 failures (`ShowAssetTests` 22 + `MemoryFragmentTests` 38).
- Full iOS suite: 266 tests passed, 0 failures on the iPhone 17 simulator.
