...
- Focused media run: 58 tests passed, 0 failures (`ShowAssetTests` 20 + `MemoryFragmentTests` 38).
- Full iOS suite: 264 tests passed, 0 failures on the iPhone 17 simulator.
