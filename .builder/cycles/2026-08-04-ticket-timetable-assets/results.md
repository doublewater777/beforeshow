...
- Focused media run: 51 tests passed, 0 failures (`ShowAssetTests` 13 + `MemoryFragmentTests` 38).
- Full iOS suite: 257 tests passed, 0 failures on the iPhone 17 simulator.
