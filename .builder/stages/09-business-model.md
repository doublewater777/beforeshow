...
Payment trigger: hitting a Pro-only AI generation or saved-show limit after experiencing value from adding at least one real show.
...
- Paid value should attach to repeated AI-backed preparation and unlimited saved shows, not to ticketing, social visibility, or public community.
...
- Free users receive one device-local first-experience package: one candidate song generation, one outbound draft, one return draft, and one show recap generation. Deleting a show does not reset this allowance, though V2.1 will not strongly defend against uninstall/reinstall resets.
- Pro unlocks unlimited saved shows, repeated AI generation, and additional show recap discovery.
